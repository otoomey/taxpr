...
class TypedClosedJaxpr[*T, R]:
    ...
    def make[*T_new, R_new](
        ...
        def wrapper(*args: *T_new, **kwargs):
            ...
            return TypedClosedJaxpr[*T_new, R_new](_to_shape(args), closed_jaxpr, out_shape, static_argnums)
        return wrapper
    ...
    def map_inputs[*K](self, map: Callable[[*K], tuple[*T]], static_argnums: int | Iterable[int] = ()) -> "Callable[..., TypedClosedJaxpr[*K, R]]":
        def new_fn(*args: *K) -> R:
...
def tcj_transpose[*T, R](tcj: TypedClosedJaxpr[*T, R]) -> tuple[TypedClosedJaxpr[*T, list[PyTree[Array]]], list[dict[str, Any]]]:
    ...
    return TypedClosedJaxpr[*T, list[PyTree[Array]]](
...
def tcj_partition_out[*T, *R](tcj: TypedClosedJaxpr[*T, tuple[*R]], outvar_indices: list[list[int]]) -> list[TypedClosedJaxpr[*T, Any]]:
